...
result_folder_path = f'D:\\A_Project\\PyCharm_Project\\CameraCalibration\\Gripper2base\\Data_({index_folder})'
value_folder_path = f'D:\\A_Project\\PyCharm_Project\\CameraCalibration\\Value\\Gripper2base\\Data_({index_folder})'
