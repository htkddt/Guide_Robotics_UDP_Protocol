...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1448, 545)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.Image_frame_1 = QtWidgets.QLabel(self.centralwidget)
        self.Image_frame_1.setGeometry(QtCore.QRect(130, 10, 640, 480))
        ...
        self.btn_Open.setGeometry(QtCore.QRect(10, 10, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.btn_Open.setFont(font)
        self.btn_Open.setObjectName("btn_Open")
        self.btn_Close = QtWidgets.QPushButton(self.centralwidget)
        self.btn_Close.setGeometry(QtCore.QRect(10, 150, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.btn_Close.setFont(font)
        self.btn_Close.setObjectName("btn_Close")
        self.btn_Detect = QtWidgets.QPushButton(self.centralwidget)
        self.btn_Detect.setGeometry(QtCore.QRect(10, 80, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.Image_frame_2.setGeometry(QtCore.QRect(780, 10, 640, 480))
